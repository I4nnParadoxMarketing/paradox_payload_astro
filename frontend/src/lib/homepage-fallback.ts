...
export const homepageFallback: Page = {
  ...
  layout: [
      ...
      services: [
        {
          ...
          title: 'Websites',
          color: '#EFB155',
          features: ['High-conversion landing pages', 'SEO & organic growth strategy', 'Messaging & content alignment', 'Mobile and performance optimisation', 'Analytics & event tracking'],
        ...
        },
        {
          ...
          title: 'Advertising',
          color: '#80CBE2',
          features: ['Google Ads & Performance Max', 'Meta advertising campaigns', 'Retargeting & audience testing', 'Conversion tracking & attribution', 'Budget optimisation & reporting'],
        ...
        },
        {
          ...
          title: 'CRMs',
          color: '#2F77B5',
          features: ['Automated email & SMS follow-ups', 'Pipeline visibility & forecasting', 'Lead scoring & segmentation', 'Deep-funnel conversion tracking', 'Data hygiene & process automation'],
    ...
    },
    {
      ...
      posts: [
        { title: 'What Social Media Marketing Really Takes to Work', date: 'August 25, 2026', url: 'https://paradoxmarketing.io/blog/', imageUrl: 'https://paradoxmarketing.io/wp-content/uploads/2026/08/Social-Media-Marketing@2x-1024x433.webp' },
        { title: 'Online Reputation Management: Protecting Your Digital Brand', date: 'August 24, 2026', url: 'https://paradoxmarketing.io/blog/', imageUrl: 'https://paradoxmarketing.io/wp-content/uploads/2026/08/Reputation-Management@2x-1024x433.webp' },
        { title: 'What Professional Website Design Actually Involves', date: 'August 24, 2026', url: 'https://paradoxmarketing.io/blog/', imageUrl: 'https://paradoxmarketing.io/wp-content/uploads/2026/08/Website-Design-Development@2x-1024x433.webp' },
      ],
    },
  ],
}
